...
public partial class SettingsContext {
    ...
    public SettingsEntity SetGameSettings(RustedGames.GameSettingsData newValue) {
        if (hasGameSettings) {
    ...
    public void ReplaceGameSettings(RustedGames.GameSettingsData newValue) {
...
public partial class SettingsEntity {
    ...
    public void AddGameSettings(RustedGames.GameSettingsData newValue) {
